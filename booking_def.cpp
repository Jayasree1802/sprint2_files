...
void MovieBooking:: management()
{
    ...
    while (loginAttempt < 5)
    {
        ...
        if (userName == "Jayasree" && userPassword == pass){
            cout << "Welcome Jayasree!" << endl;
            break;
        }
        else if (userName == "Ramya" && userPassword == pass){
            cout << "Welcome Ramya!" << endl;
            break;
        }
        else if (userName == "Chandrika" && userPassword == pass){
            cout << "Welcome Chandrika!" << endl;
            break;
        }
        else if (userName == "Rohini" && userPassword == pass){
            cout << "Welcome Rohini!" << endl;
            break;
        }
        else if (userName == "Mounika" && userPassword == pass){
            cout << "Welcome Mounika!" << endl;
            break;
        }
        else{
